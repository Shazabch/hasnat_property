...
class TokenReceiptListManagementComponent extends Component
{
    use WithPagination;
    ...
    {
        $tokenReceipts = TokenReipet::query()
            ...
            return view('livewire.admin.tokens.token-receipt-list-management-component', compact('tokenReceipts'));
    }
}
