<div class="box b-box"> 
    <a href="{{ route('publications.detail', $publication->slug) }}">
        ...
        <div class="details"> 
            ...
            <a class="title" href="{{ route('publications.detail', $publication->slug) }}">{{ $publication->title }}</a> <a class="button smaller bordered stretched-link" href="{{ route('publications.detail', $publication->slug) }}">Read More</a> 
        </div>
    </a>
</div>