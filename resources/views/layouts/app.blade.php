...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary text-capitalize">{{ auth()->user()->name }}</a>
						<div class="navi mt-2">
							<a href="#" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary">@foreach(auth()->user()->roles as $role) {{ $role->name }} @endforeach</span>
								</span>
							</a>
							<a href="#" class="navi-item">
								<span class="navi-link p-0 pb-2">
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<!--end:Item-->
					<!--begin::Item-->
					<a href="{{ route('profile.change-password') }}" class="navi-item">
						<div class="navi-link">
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
					...
					<!--end:Item-->
					<!--begin::Item-->
					<a href="" class="navi-item logout-button">
						<div class="navi-link">
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
							...
							<div class="navi-text">
								<div class="font-weight-bold text-danger">Log Out</div>
								<div class="text-muted">Logout of your account.</div>
							</div>
						</div>
					</a>
					<!--end:Item-->
		...
		<!--end::Chat Panel-->
		{{-- Create a bs 4 modal which do not close on clicking outside --}}
		<div>
			<div class="modal fade" id="schemaModal" tabindex="-1" role="dialog" aria-labelledby="schemaModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
				<div class="modal-dialog modal-xl" role="document">
					<div class="modal-content">
						...
						@livewire('admin.schemas.create-edit-component')
					</div>
				</div>
			</div>
		</div>
