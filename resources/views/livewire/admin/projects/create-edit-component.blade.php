                ...
                <form wire:submit="save">
                    <div class="row gutters-0 mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <div wire:ignore>
                                    <div class="" x-data x-init="ClassicEditor
                                        ...
                                        x-ref="project_content">{!! $project->content !!}</div>
                                </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            @if ($isNew)
                                <button wire:click.prevent="save(true)" class="btn btn-primary"
                                    wire:loading.attr="disabled" wire:loading.class="opacity-50 cursor-not-allowed">Save
                                    & Add Another</button>
                            @endif
                        </div>
                    </div>
