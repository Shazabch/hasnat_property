...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            <span class=" font-weight-bold mr-4">Web Pages</span>
        ...
        <div class="d-flexs align-items-center">
            <a href="{{ route('admin.web-pages.create') }}" class="btn btn-light-warning font-weight-bolder btn-sm">Create New Web Page</a>
        </div>
        <!--end::Toolbar-->
    </div>
</div>
    <div class="row mx-2">
        <div class="col-12">
            @livewire('admin.web-pages.listing-component')
        </div>
    </div>
@endsection
